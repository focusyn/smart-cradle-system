...
export default function Analytics() {
  ...
  //     if (data) {
  //       // console.log(data);
  //       setTemperture(data?.sensor);
  //       setHumidity(data?.sensor);
  //       setSoilMoisture(data?.sensor);
  //       setWaterLevel(data?.sensor);
  //       setMotion(data?.sensor?.motion.toString());
  //       setSwing(data?.swing);
  //       setSwingSpeed(data?.speed);
  ...
  const togglePump = () => {
    toast.success("Pump is " + (swing ? "OFF" : "ON"));
    setLoading(true);
    setSwing(!swing);
    const dbRef = ref(RTDB, "/swing");
    ...
    <div className="mt-5 mb-10">
      ...
      <div className="mt-3 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-6">
        ...
        <Widget
          ...
          title="Moisture"
          subtitle={soilMoisture + " kg/kg or m~/m3"}
        />
        <ServerSendData />
